...
namespace NWN
{
    public partial class NWScript
    {
        ...
        {
            NWN.Internal.NativeFunctions.StackPushInteger(nUseable? 1 : 0);
        ...
        {
            NWN.Internal.NativeFunctions.StackPushInteger(bIdentifiedDescription? 1 : 0);
            NWN.Internal.NativeFunctions.StackPushInteger(bOriginalDescription? 1 : 0);
            NWN.Internal.NativeFunctions.StackPushObject(oObject);
        ...
        {
            NWN.Internal.NativeFunctions.StackPushInteger((int)nColorChannel);
            NWN.Internal.NativeFunctions.StackPushObject(oObject);
        ...
        {
            NWN.Internal.NativeFunctions.StackPushInteger(bLocked? 1 : 0);
        ...
        {
            NWN.Internal.NativeFunctions.StackPushInteger(nKeyRequired? 1 : 0);
            NWN.Internal.NativeFunctions.StackPushObject(oObject);
        ...
        {
            NWN.Internal.NativeFunctions.StackPushInteger(nLockable? 1 : 0);
            NWN.Internal.NativeFunctions.StackPushObject(oObject);
        ...
        {
            NWN.Internal.NativeFunctions.StackPushInteger(nPlotFlag? 1 : 0);
            NWN.Internal.NativeFunctions.StackPushObject(oTarget);
        ...
        /// </summary>
        public static void SetIsDestroyable(bool bDestroyable = true, bool bRaiseable = true, bool bSelectableWhenDead = false)
        {
            NWN.Internal.NativeFunctions.StackPushInteger(bSelectableWhenDead? 1 : 0);
            NWN.Internal.NativeFunctions.StackPushInteger(bRaiseable? 1 : 0);
            NWN.Internal.NativeFunctions.StackPushInteger(bDestroyable? 1 : 0);
        ...
        {
            NWN.Internal.NativeFunctions.StackPushInteger(nLocked? 1 : 0);
            NWN.Internal.NativeFunctions.StackPushObject(oTarget);
        ...
        public static ObjectType GetObjectType(uint oTarget)
        {
            ...
            return (ObjectType)NWN.Internal.NativeFunctions.StackPopInteger();
        }
