...
namespace NWN
{
    public partial class NWScript
    {
        ...
        {
            NWN.Internal.NativeFunctions.StackPushInteger(nLeftClickingEnabled? 1 : 0);
            NWN.Internal.NativeFunctions.StackPushInteger(nInCutscene? 1 : 0);
            NWN.Internal.NativeFunctions.StackPushObject(oCreature);
        ...
        public static void PopUpDeathGUIPanel(uint oPC, bool bRespawnButtonEnabled = true, bool bWaitForHelpButtonEnabled = true, int nHelpStringReference = 0, string sHelpString = "")
        {
            ...
            NWN.Internal.NativeFunctions.StackPushInteger(bWaitForHelpButtonEnabled? 0 : 1);
            NWN.Internal.NativeFunctions.StackPushInteger(bRespawnButtonEnabled? 0 : 1);
        ...
        {
            NWN.Internal.NativeFunctions.StackPushInteger((int)nGUIPanel);
            NWN.Internal.NativeFunctions.StackPushObject(oPC);
