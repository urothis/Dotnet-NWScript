...
namespace NWN
{
    public partial class NWScript
    {
        ...
        public static Weather GetWeather(uint oArea)
        {
            ...
            return (Weather)NWN.Internal.NativeFunctions.StackPopInteger();
        }
        ...
        {
            NWN.Internal.NativeFunctions.StackPushObject(oArea);
            NWN.Internal.NativeFunctions.StackPushInteger((int)nSkyBox);
        ...
        {
            NWN.Internal.NativeFunctions.StackPushObject(oArea);
            NWN.Internal.NativeFunctions.StackPushInteger((int)nFogColor);
        ...
        public static Skybox GetSkyBox(uint oArea = OBJECT_INVALID)
        {
            ...
            return (Skybox)NWN.Internal.NativeFunctions.StackPopInteger();
        }
        ...
        {
            NWN.Internal.NativeFunctions.StackPushInteger(bExplored? 0 : 1);
        ...
        {
            NWN.Internal.NativeFunctions.StackPushInteger((int)nWeather);
            NWN.Internal.NativeFunctions.StackPushObject(oTarget);
        ...
        {
            NWN.Internal.NativeFunctions.StackPushInteger(newState? 1 : 0);
        ...
        {
            NWN.Internal.NativeFunctions.StackPushInteger(bEnabled? 1 : 0);
        ...
        public static void SetAreaTransitionBMP(AreaTransition nPredefinedAreaTransition, string sCustomAreaTransitionBMP = "")
        {
            ...
            NWN.Internal.NativeFunctions.StackPushInteger((int)nPredefinedAreaTransition);
