...
namespace NWN
{
    public partial class NWScript
    {
        ...
        /// </summary>
        public static int LevelUpHenchman(uint oCreature, Classes nClass = Classes.Invalid, bool bReadyAllSpells = false, Package nPackage = Package.Invalid)
        {
            NWN.Internal.NativeFunctions.StackPushInteger((int)nPackage);
            NWN.Internal.NativeFunctions.StackPushInteger(bReadyAllSpells? 1 : 0);
        ...
        public static uint GetAssociate(Type nAssociateType, uint oMaster = OBJECT_INVALID, int nTh = 1)
        {
            ...
            NWN.Internal.NativeFunctions.StackPushObject(oMaster);
            NWN.Internal.NativeFunctions.StackPushInteger((int)nAssociateType);
