...
namespace NWN
{
    public partial class NWScript
    {
        ...
        public static FootstepType GetFootstepType(uint oCreature = OBJECT_INVALID)
        {
            ...
            return (FootstepType)NWN.Internal.NativeFunctions.StackPopInteger();
        }
        ...
        {
            NWN.Internal.NativeFunctions.StackPushObject(oCreature);
            NWN.Internal.NativeFunctions.StackPushInteger((int)nFootstepType);
        ...
        public static PhenoType GetPhenoType(uint oCreature)
        {
            ...
            return (PhenoType)NWN.Internal.NativeFunctions.StackPopInteger();
        }
        ...
        {
            NWN.Internal.NativeFunctions.StackPushObject(oCreature);
            NWN.Internal.NativeFunctions.StackPushInteger((int)nPhenoType);
        ...
        public static ClassType GetLastSpellCastClass()
        {
            ...
            return (ClassType)NWN.Internal.NativeFunctions.StackPopInteger();
        }
        ...
        {
            NWN.Internal.NativeFunctions.StackPushInteger((int)nAppearanceType);
            NWN.Internal.NativeFunctions.StackPushObject(oCreature);
        ...
        {
            NWN.Internal.NativeFunctions.StackPushInteger(bLootable? 1 : 0);
            NWN.Internal.NativeFunctions.StackPushObject(oCreature);
        ...
        {
            NWN.Internal.NativeFunctions.StackPushInteger((int)nMode);
            NWN.Internal.NativeFunctions.StackPushObject(oCreature);
            NWN.Internal.NativeFunctions.CallBuiltIn(735);
            return (ActionMode)NWN.Internal.NativeFunctions.StackPopInteger();
        }
        ...
        {
            NWN.Internal.NativeFunctions.StackPushInteger(nStatus? 1 : 0);
            NWN.Internal.NativeFunctions.StackPushInteger((int)nMode);
            NWN.Internal.NativeFunctions.StackPushObject(oCreature);
        ...
        public static AILevel GetAILevel(uint oTarget = OBJECT_INVALID)
        {
            ...
            return (AILevel) NWN.Internal.NativeFunctions.StackPopInteger();
        }
        ...
        {
            NWN.Internal.NativeFunctions.StackPushInteger((int)nAILevel);
            NWN.Internal.NativeFunctions.StackPushObject(oTarget);
        ...
        {
            NWN.Internal.NativeFunctions.StackPushInteger(bImproved? 1 : 0);
        ...
        {
            NWN.Internal.NativeFunctions.StackPushInteger(bImmortal? 1 : 0);
            NWN.Internal.NativeFunctions.StackPushObject(oCreature);
        ...
        public static StealthMode GetStealthMode(uint oCreature)
        {
            ...
            return (StealthMode)NWN.Internal.NativeFunctions.StackPopInteger();
        }
        ...
        public static DetectMode GetDetectMode(uint oCreature)
        {
            ...
            return (DetectMode)NWN.Internal.NativeFunctions.StackPopInteger();
        }
        ...
        public static CastingMode GetDefensiveCastingMode(uint oCreature)
        {
            ...
            return (CastingMode)NWN.Internal.NativeFunctions.StackPopInteger();
        }
        ...
        public static AppearanceType GetAppearanceType(uint oCreature)
        {
            ...
            return (AppearanceType)NWN.Internal.NativeFunctions.StackPopInteger();
        }
        ...
        {
            NWN.Internal.NativeFunctions.StackPushInteger(bDestroy? 0 : 1);
        ...
        public static DisturbType GetInventoryDisturbType()
        {
            ...
            return (DisturbType)NWN.Internal.NativeFunctions.StackPopInteger();
        }
        ...
        {
            NWN.Internal.NativeFunctions.StackPushObject(oCreature);
            NWN.Internal.NativeFunctions.StackPushInteger((int)nClassType);
        ...
        ///  - oCreature
        /// </summary>
        public static int GetAbilityModifier(Ability nAbility, uint oCreature = OBJECT_INVALID)
        {
            NWN.Internal.NativeFunctions.StackPushObject(oCreature);
        ...
        public static RacialType GetRacialType(uint oCreature)
        {
            ...
            return (RacialType)NWN.Internal.NativeFunctions.StackPopInteger();
        }
    }
}