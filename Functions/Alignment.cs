...
namespace NWN
{
    public partial class NWScript
    {
        ...
        ///  * No return value
        /// </summary>
        public static void AdjustAlignment(uint oSubject, Alignment nAlignment, int nShift, bool bAllPartyMembers = true)
        {
        ...
        public static Alignment GetAlignmentLawChaos(uint oCreature)
        {
            ...
            return (Alignment)NWN.Internal.NativeFunctions.StackPopInteger();
        }
        ...
        public static void SetIsTemporaryFriend(uint oTarget, uint oSource = OBJECT_INVALID, bool bDecays = false, float fDurationInSeconds = 180.0f)
        {
            ...
            NWN.Internal.NativeFunctions.StackPushInteger(bDecays? 1 : 0);
            NWN.Internal.NativeFunctions.StackPushObject(oSource);
            NWN.Internal.NativeFunctions.StackPushObject(oTarget);
