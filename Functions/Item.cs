...
namespace NWN
{
    public partial class NWScript
    {
        ...
        public static ItemAppearance GetItemAppearance(uint oItem, ItemAppearanceType nType, int nIndex)
        {
            ...
            return (ItemAppearance)NWN.Internal.NativeFunctions.StackPopInteger();
        }
        ...
        {
            NWN.Internal.NativeFunctions.StackPushInteger(bCopyVars? 0 : 1);
        ...
        {
            NWN.Internal.NativeFunctions.StackPushInteger(bInfinite? 1 : 0);
            NWN.Internal.NativeFunctions.StackPushObject(oItem);
        ...
        {
            NWN.Internal.NativeFunctions.StackPushInteger(nStolen? 1 : 0);
            NWN.Internal.NativeFunctions.StackPushObject(oItem);
        ...
        {
            NWN.Internal.NativeFunctions.StackPushInteger(bPickpocketable? 1 : 0);
            NWN.Internal.NativeFunctions.StackPushObject(oItem);
        ...
        {
            NWN.Internal.NativeFunctions.StackPushInteger(bDroppable? 1 : 0);
            NWN.Internal.NativeFunctions.StackPushObject(oItem);
        ...
        {
            NWN.Internal.NativeFunctions.StackPushInteger(bIdentified? 1 : 0);
            NWN.Internal.NativeFunctions.StackPushObject(oItem);
